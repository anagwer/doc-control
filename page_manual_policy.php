...
<?php
	...
	$select = "SELECT * from manual_policy ORDER BY id_manual ASC";
			...
			<tbody>
				...
				?> 
					<tr>
						...
						<?php
							if ($file_police!=null){
								echo "<td><a href='index.php?option=com_content&view=article&id=117&idfile=".$file_police."' title=".$file_police.">".$code_document."</a></td>";
								}else{ 
