...
<?php
	...
	if ($_FILES["filepolice"]["size"] > 100000000) {
...
<?php
$tampil = mysql_fetch_array(mysql_query("SELECT * FROM manual_policy WHERE id_manual = '".$_GET['id_manual']."'")); 
{
?>
<?php	
	 if(!empty($err))  {
...
<form method="POST" action="" enctype="multipart/form-data" >
	<table align="center">
		...
		<tr>
			<td>Owner Dokumen</td>
			<td>:</td>
			<td><input type="text" name="owner_document" value="<?=$tampil['owner_document']?>" class="form-control" required/></td>
		</tr>
		<tr>
...
<?php
	...
	echo "<tr>
		...
		<td>".$ia."</td>
		<td>
		<a href='?key=edit&id_manual=$id_manual' class='btn btn-info btn-xs'>Edit</a>
		<a href='?key=hapus&id_manual=$code_document' class='btn btn-danger btn-xs'>Hapus</a>
