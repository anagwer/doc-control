...
session_start();
	...
	if ($del){
		...
		<?php
		echo "<script>window.location.href='index.php/report-list/add-report';</script>";
	}
	}
	...
	if ($_FILES["file_report"]["size"] > 1000000000) {
		...
		//upload digagalkan
		echo "<script>window.location.href='index.php/reporting/add-report';</script>";
	}
...
echo "<tr>
	...
	if ($file_report!=null){
	echo "<td><a href='uploads_file/all_doc/".$file_report."' title=".$file_report.">".$judul_report."</a></td>";
	}else{ 
