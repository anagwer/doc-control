...
class AriUtils
{
	function sortAssocArray($data, $key, $dir = 'asc', $cmp = 'string')
	{
	...
	{
		$maxSize = min((int)(ini_get('upload_max_filesize')) * 1024 * 1024, (int)(ini_get('post_max_size')) * 1024 * 1024);
		$memoryLimit = (int) (ini_get('memory_limit')) * 1024 * 1024;
		if ($memoryLimit > 0)
			$maxSize = min($maxSize, $memoryLimit);
