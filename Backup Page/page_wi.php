...
if(isset($_POST['submit'])){ //jika tombol submit di set atau dijalankan maka melakukan aksi
	...
	echo "<script>window.location.href='http://businessprocess/ict/index.php/wi/add-wi';</script>";
	exit;
}
...
<tr>
	<tr>
		...
		<th bgcolor='silver' rowspan='2' style='text-align:center; padding-top:20px;'>Judul Dokumen</th>
...
echo "<tr>
	...
	if ($file_wi!=null){
	//echo "<td><a href='http://100.100.1.148/documentcontrol/uploads_file/doc_wi/".$file_wi."' target='_blank' title=".$file_wi.">".$code_document."</a></td>";
	echo "<td><a href='index.php?option=com_content&view=article&id=119&idfile=".$file_wi."' title=".$file_wi.">".$code_document."</a></td>";
	}else{ 
