...
if(isset($_POST['submit'])){ //jika tombol submit di set atau dijalankan maka melakukan aksi
	...
	//deklarasi variable $table, $field yang akan digunakan untuk fungsi insert data
		$table = "INSERT INTO standard_doc SET";
	...
	echo "<script>window.location.href='http://businessprocess/ict/index.php/standard-doc/add-standard-doc';</script>";
	exit;
}
...
$select = "SELECT * from standard_doc";
...
<tr>
	<tr>
		<th bgcolor='silver' rowspan='2' style='text-align:center; padding-top:20px;'>No</th>
		<th bgcolor='silver' rowspan='2' style='text-align:center; padding-top:20px;'>Kode Dokumen</th>
		<th bgcolor='silver' rowspan='2' style='text-align:center; padding-top:20px;'>Nomor Revisi</th>
		<th bgcolor='silver' rowspan='2' style='text-align:center; padding-top:30px;'>Judul Dokumen</th>
		<th bgcolor='silver' rowspan='2' style='text-align:center; padding-top:20px;'>Owner Dok.</th>
...
echo "<tr>
	...
	if ($file_stand_doc!=null){
	//echo "<td><a href='http://100.100.1.148/documentcontrol/uploads_file/doc_standar_doc/".$file_stand_doc."' target='_blank' title=".$file_stand_doc.">".$code_document."</a></td>";
	echo "<td><a href='index.php?option=com_content&view=article&id=120&idfile=".$file_stand_doc."' title=".$file_stand_doc.">".$code_document."</a></td>";
	}else{ 
