...
session_start();
	...
	echo "<script>window.location.href='http://businessprocess/documentcontrol/index.php/sop/sop';</script>";
	exit;
	}
?>
...
session_start();
	...
	<tr>
		<tr>
			...
			<th bgcolor='silver' rowspan='2' style='text-align:center;'>Owner Dok.</th>
