...
<?php
	...
	if(isset($_POST['submit'])){ //jika tombol submit di set atau dijalankan maka melakukan aksi
		...
		$table = "INSERT INTO departement SET";
		...
		echo "<script>window.location.href='index.php/reporting/add-departement';</script>";
		exit;
	}
?>
...
<form method="POST" action="" enctype="multipart/form-data" >
	<table align="center">
		<tr>
			...
			<td>:</td>
			<td><input type="text" name="dep_name" class="form-control" required/></td>
		</tr>
		<tr>
			<td>Kode</td>
			<td>:</td>
