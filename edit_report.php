...
<?php
	...
	if ($_GET['key']=='hapus'){
		...
		$qryDelete = "DELETE FROM report WHERE id_report='$id_report'";
...
<?php
	$tampil = mysql_fetch_array(mysql_query("SELECT * FROM report WHERE id_report = '".$_GET['id_report']."'")); 
	{
	?>
	<?php	
		 if(!empty($err))  {
